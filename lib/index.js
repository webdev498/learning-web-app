...
angular.module('cgiSheApp', [uirouter,account,login,main,user,exam,index,choice,category,
  ...
  .config(function($authProvider) {
    var serverUri = process.env.API_HOST;
    $authProvider.facebook({
      clientId: process.env.FACEBOOK_CLIENT_ID,
      url: serverUri + '/login/facebook'
    });

    $authProvider.google({
      clientId: process.env.GOOGLE_CLIENT_ID,
      url: serverUri + '/login/google'
    });
  })
