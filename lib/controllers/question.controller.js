      ...
      this.api.createQuestion(this.question)
        .then(function (response) {
          ...
          for (let i = 0; i < response.choices.length; i++) {
            instance.choices[i].id = response.choices[i].id; 
            instance.choices[i].createdAt = response.choices[i].createdAt; 
            instance.choices[i].updatedAt = response.choices[i].updatedAt;  
          }
